    ...
    <Background>
      ...
      <div className="blog-article relative mx-auto w-full max-w-3xl px-4 sm:px-4 py-8 font-sans flex flex-col min-h-screen">
        ...
        <section className="mb-8">
          ...
          <ImageModal
            src="/seven-thousand-days-old/finalists.webp"
          ...
          <ImageModal
            src="/seven-thousand-days-old/webps1.webp"
          ...
          <ImageModal
            src="/seven-thousand-days-old/webps3.webp"
          ...
          <ImageModal
            src="/seven-thousand-days-old/aimlps1.webp"
