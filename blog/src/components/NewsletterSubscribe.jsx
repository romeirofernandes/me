    ...
    <Border1>
      <Card className="w-full max-w-3xl mx-auto border-0 shadow-none rounded-none light:bg-white dark:bg-zinc-900">
        <CardContent className="py-4 px-6">
          <h2 className="text-lg font-semibold mb-1 text-left text-white light:text-zinc-900">
            If you want, I can email you when I post something new
          </h2>
          <p className="text-muted-foreground mb-4 text-left text-sm text-zinc-400 light:text-zinc-500">
          ...
          >
            <Input
              type="email"
              className="flex-1 text-sm rounded-none border-[#232323] light:border-zinc-300 bg-transparent text-white light:text-zinc-900 placeholder:text-zinc-500 light:placeholder:text-zinc-400 focus-visible:ring-0 light:bg-zinc-50 light:text-zinc-900 light:caret-zinc-900"
            ...
            <Button
              type="submit"
              className="font-medium text-sm rounded-none flex items-center justify-center gap-2"
              disabled={loading}
