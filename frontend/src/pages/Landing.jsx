        ...
        <DiagonalBackground className="min-h-screen">
          <div className="flex flex-col md:flex-row min-h-screen text-[#f5f5f7] overflow-x-hidden">
            ...
            <main className="relative flex-1 flex flex-col items-center px-0 pb-2 md:pb-4 mt-0 md:mt-0 w-full">
              ...
              <div className="w-full max-w-[98vw] md:max-w-2xl px-2 md:px-0 animate-in animate-delay-2">
                <ProfileCard />
              </div>

              <div className="w-full max-w-[98vw] md:max-w-2xl px-2 md:px-0 animate-in animate-delay-3">
              ...
              <div className="w-full max-w-[98vw] md:max-w-2xl px-2 sm:px-4 animate-in animate-delay-4">
              ...
              <div className="animate-in animate-delay-5"><TechMarquee /></div>

              <div className="animate-in animate-delay-6"><WorkExperience /></div>

              <div className="animate-in animate-delay-7"><Projects /></div>

              <div className="animate-in animate-delay-8"><Achievements /></div>

              <div className="w-full max-w-[98vw] md:max-w-2xl px-2 animate-in animate-delay-9">
                <ContactSection />
              </div>

              <div className="w-full max-w-[98vw] md:max-w-2xl px-2 animate-in animate-delay-10">
                <QuoteBox>
              ...
              <div className="mt-8 mb-4 flex w-full max-w-[98vw] justify-center px-2 md:max-w-2xl animate-in animate-delay-11">
                <Signature
              ...
              <div className="animate-in animate-delay-11"><Footer /></div>
            </main>
          </div>
        </DiagonalBackground>
      )}
