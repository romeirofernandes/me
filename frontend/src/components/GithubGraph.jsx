...
export default function GithubGraph({ username, data: propData }) {
  ...
  if (!data) {
    return (
      <div className="flex justify-center">
        <div className="rounded-lg p-4 w-full animate-pulse bg-[var(--glass-bg)] backdrop-blur-xl border border-white/10">
  ...
  return (
    <div className="flex justify-center">
      <div className="relative z-10 isolate rounded-lg p-4 w-full bg-[var(--glass-bg)] backdrop-blur-xl border border-white/10 shadow-xl">
