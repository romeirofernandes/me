        ...
        <div className="flex flex-row gap-2 mt-2 w-full">
          {preview ? (
            <a
              ...
              className="flex-1 px-4 py-2 rounded-lg border border-white/10 bg-[var(--glass-bg-20)] backdrop-blur-md text-sm text-white font-medium transition text-center shadow-md"
          ...
          {href ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 px-4 py-2 rounded-lg border border-white/10 bg-[var(--glass-bg-20)] backdrop-blur-md text-sm text-white font-medium transition text-center shadow-md flex items-center justify-center gap-2"
              onClick={(e) => e.stopPropagation()}
              data-cuelume-press
              data-cuelume-release
            >
