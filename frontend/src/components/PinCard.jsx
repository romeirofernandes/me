        ...
        <div className="flex flex-row gap-2 mt-2 w-full">
          {preview ? (
            <a
              ...
              className="flex-1 px-4 py-2 rounded-lg border border-white/10 bg-black/20 backdrop-blur-md text-sm text-white font-medium transition text-center shadow-md focus:outline-none focus:ring-2 focus:ring-[#f5f5f7] focus:ring-offset-2"
          ...
          {href ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 px-4 py-2 rounded-lg border border-white/10 bg-black/20 backdrop-blur-md text-sm text-white font-medium transition text-center shadow-md flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-[#f5f5f7] focus:ring-offset-2"
              onClick={(e) => e.stopPropagation()}
            >
