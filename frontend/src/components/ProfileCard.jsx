...
export default function ProfileCard() {
  return (
    <div className="w-full max-w-2xl mx-auto bg-[#18181b] rounded-xl shadow-lg p-7 mb-8 flex flex-col gap-2 border border-[#232323] relative">
      <div className="absolute top-4 right-4 flex gap-6">
        <a
          ...
          aria-label="GitHub"
        >
          <FaGithub className="text-xl text-gray-400 hover:text-[#f5f5f7] transition" />
        </a>
        <a
          href="https://x.com/romeirofernandes"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="X"
        >
          <FaTwitter className="text-xl text-gray-400 hover:text-[#f5f5f7] transition" />
        </a>
      </div>
      ...
      <a
        ...
        className="flex items-center gap-2 text-sm text-[#f5f5f7] underline hover:text-gray-300 transition"
      >
